...
<head>
    ...
    <script type="text/javascript" src="../test/multiscroll.responsive.min.js"></script>
	<script type="text/javascript" src="../test/jquery.multiscroll.min.js"></script>
...
<div id="myContainer">
	...
	<div class="ms-left">
		<div class="ms-section" id="left1" data-id="1">
			<h1>Left 1</h1>
		</div>

		<div class="ms-section" id="left2" data-id="3">
			<h1>Left 2 </h1>
		</div>

		<div class="ms-section" id="left3" data-id="5">
			<h1>Left 3</h1>
		</div>
	</div>
	
	<div class="ms-right">
		<div class="ms-section" id="right1" data-id="2">
			<h1>Right 1</h1>
		</div>

		<div class="ms-section" id="right2" data-id="4">
			<h1>Right 2</h1>
		</div>

		<div class="ms-section" id="right3" data-id="6">
			<h1>Right 3</h1>
		</div>
	</div>	
</div>
