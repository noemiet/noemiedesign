...
(function($, window, document, Math, undefined) {
	...
	$.fn.multiscroll = function(options) {
		...
		*/
		...
		function silentScroll(){
			...
			if(options.css3 && options.autoScrolling){
                ...
                $('html,body').scrollTop($('.ms-left').find('.ms-section.active').position().top);
            }
		}
		...
		*/
		...
		MS.getMultiscrollData = function(){
            return {
                options: options,
                internals: {
                	isTouchDevice: isTouchDevice,
                	numberSections: numberSections,
                	setLastScrollDestiny: setLastScrollDestiny,
                	setURLHash: setURLHash,
                	activateMenuElement: activateMenuElement,
                	activateNavDots: activateNavDots,
                	getYmovement: getYmovement,
                	removeMouseWheelHandler: removeMouseWheelHandler,
        ...
        function setLastScrollDestiny(value){
        	lastScrolledDestiny = value;
        }

		loadExtension('responsive');
        ...
        */
        function loadExtension(internalName){
            var externalName = 'ms_' + internalName + 'Extension';

            MS[internalName] = typeof window[externalName] !=='undefined' ? new window[externalName]() : null;
        }
